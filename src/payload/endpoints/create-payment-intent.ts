...
//               // Modify this part to directly use product.price
//         const prices = await payload.collections ({
//           collection: 'prices', // Assuming 'prices' is your collection name in Payload CMS
