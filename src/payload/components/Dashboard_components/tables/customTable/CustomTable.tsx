...
import { complex, Itable as Props } from '../../../interfaces/Itable'
      ...
      return (
        <tr key={index}>
          ...
          <td className={classes.userName}>
            <img className={classes.avatar} src={item.avatar} alt="user avatar" />
            {item.userName}
          </td>
      ...
      return (
        <tr key={index}>
          ...
          <td className={classes.product_name}>
            <img className={classes.product_img} src={item.pic} alt="user avatar" />
            {item.product}
          </td>
