...
import { markProductAsFlashSale } from './hooks/markProductAsFlashSale'
...
const Products: CollectionConfig = {
  ...
  hooks: {
    ...
    afterChange: [revalidateProduct, markProductAsFlashSale],
  ...
  fields: [
    ...
    {
      name: 'brands', // Now using imported brands
      type: 'select',
      admin: {
        isClearable: true,
        position: 'sidebar',
